    ...
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            if (!_noConnection)
            {
                ...
                // Bootstrap: apply bypass flag method if enabled
                if (App.Settings.Prop.UseBypassFlagMethod && App.Settings.Prop.UseFastFlagManager)
                {
                    App.Logger.WriteLine("Bootstrapper::Run", "Applying bypass flag write...");
                    App.FastFlags.BypassWriteFlags();
                }
            }
